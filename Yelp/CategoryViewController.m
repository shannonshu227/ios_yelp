...
@interface CategoryViewController () <UITableViewDataSource,UITableViewDelegate,SwitchCellDelegate>
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.on = [self.selectedIndexPath containsObject:indexPath];
...
- (void) onApplyButton {
    NSLog(@"test:%lu", (unsigned long)self.selectedIndexPath.count);
    [self.delegate categoryViewController:self didChangeCategories:self.filters atIndexPath:self.selectedIndexPath];
